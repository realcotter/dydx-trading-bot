from constants import TOKEN_FACTOR_10, ZSCORE_THRESH, USD_PER_TRADE, USD_MIN_COLLATERAL
...
def open_positions(client):
    ...
    Store trades for managing later on exit
    """
    ...
    for index, row in df.iterrows():
        ...
        # print(base_market, quote_market, hedge_ratio, half_life)
        ...
        # print(z_score)
            ...
            if abs(z_score) >= ZSCORE_THRESH:
                ...
                if not is_base_open and not is_quote_open:
                    ...
                    for coin in TOKEN_FACTOR_10:
                        if base_market == coin:
                            base_quantity = float(int(base_quantity/10)*10)
                        if quote_market == coin:
