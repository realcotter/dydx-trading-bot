...
class BotAgent:
    ...
    """
    Primary function of BotAgent handels opening and checking order status
    """
        ...
        if order_status_m2 != "live":
            ...
            try:
                ...
                if order_status_close_order != "FILLED":
                    ...
                    # Send Message
                    send_message("Failed to execute. Error code: 100")
                ...
                # Send Message
                send_message("Failed to execute. Error code: 101")
